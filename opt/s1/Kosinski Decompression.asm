...
KosDec:
		...
		subq.w	#2,sp	; make space for 2 bytes on the stack | changed from longword into word as longword is pointless.
		move.b	(a0)+,1(sp)
		move.b	(a0)+,(sp)
...
Kos_Done:
		addq.w	#2,sp	; restore stack pointer | changed from longword into word as longword is pointless.
		rts
