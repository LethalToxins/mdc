...
; loc_177A:
EniDec_100:
		bsr.s	EniDec_FetchInlineValue ; changed to bsr.s, makes it run slightly faster.
; loc_177E:
...
EniDec_111:
		...
		beq.s	EniDec_Done
; loc_17A8:
@loop:		bsr.s	EniDec_FetchInlineValue	; fetch new inline value | changed to bsr.s, makes it run slightly faster.
